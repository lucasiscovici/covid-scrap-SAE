...
const getDatas = async (page)  => {
  ...
  await page.waitForSelector(selectA);
...
(async () => {
  ...
  await page.waitForSelector('.panel > #collapseImplantation > .panel-body > .radio:nth-child(4) > label')
  await page.click('.panel > #collapseImplantation > .panel-body > .radio:nth-child(4) > label')
  
  await page.waitForSelector('.panel-body > .radio:nth-child(4) > .radioListe > .multiselect > .multiselect')
  await page.click('.panel-body > .radio:nth-child(4) > .radioListe > .multiselect > .multiselect')
  
  await page.waitForSelector('.open > .multiselect-container > li:nth-child(3) > a > .checkbox')
  await page.click('.open > .multiselect-container > li:nth-child(3) > a > .checkbox')
  
  await page.waitForSelector('#recherche > .container-fluid > #aside > #rechercheForm > .form-block:nth-child(1)')
  await page.click('#recherche > .container-fluid > #aside > #rechercheForm > .form-block:nth-child(1)')
  
  await page.waitForSelector('#accordion > .panel > #bordereauFsAccordeon > .panel-title > a')
  await page.click('#accordion > .panel > #bordereauFsAccordeon > .panel-title > a')
  
  await page.waitForSelector('.panel > #collapseBordereauFS #bordereauSelected')
  ...
  await wait(1000);
  await page.waitForSelector('#aside > #rechercheForm #rechercheButton')
  await page.click('#aside > #rechercheForm #rechercheButton')


  var bar = new ProgressBar('[:bar] :percent :etas (:n)', { total: 101 });
  const a = [];
